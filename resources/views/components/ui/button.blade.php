...
@php($tone = match ($variant) {
    'danger' => 'btn-danger',
    'secondary' => 'border bg-[var(--surface-card)] text-slate-700 hover:border-[var(--brand-primary)] dark:bg-[#16233c] dark:text-slate-200',
    'ghost' => 'text-[var(--brand-primary)] hover:bg-sky-50',
    default => 'btn-brand',
})

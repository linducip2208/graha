...
<h1 class="text-3xl font-black">Ikhtisar Keuangan</h1>
...
<article class="rounded-2xl border bg-white p-5 shadow-sm"><p class="text-xs font-bold uppercase tracking-wide text-slate-500">Saldo Kas & Bank (GL)</p><p class="mt-1 text-2xl font-black">Rp {{ number_format($cashBalance, 0, ',', '.') }}</p><a href="/admin/cash-bank" class="text-xs font-bold text-sky-700">Kas & Bank →</a></article>
<article class="rounded-2xl border bg-white p-5 shadow-sm"><p class="text-xs font-bold uppercase tracking-wide text-slate-500">Piutang Outstanding</p><p class="mt-1 text-2xl font-black">Rp {{ number_format((float) $arOutstanding, 0, ',', '.') }}</p><a href="/admin/reports/aging" class="text-xs font-bold text-sky-700">Aging →</a></article>
<article class="rounded-2xl border bg-white p-5 shadow-sm"><p class="text-xs font-bold uppercase tracking-wide text-slate-500">Utang Outstanding</p><p class="mt-1 text-2xl font-black">Rp {{ number_format((float) $apOutstanding, 0, ',', '.') }}</p><a href="/admin/procurement-accounting" class="text-xs font-bold text-sky-700">Posting →</a></article>

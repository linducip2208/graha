<x-layouts.app title="Pengaturan"><div class="page-container">
<x-ui.page-header title="Pengaturan" />
...
<label class="flex items-center gap-3 self-end rounded-xl border p-3 text-sm"><input type="checkbox" name="require_cleaning_inspection" value="1" @checked($values['require_cleaning_inspection'] === '1')> <span class="font-semibold">Gate inspeksi bottom cleaning wajib sebelum casting</span></label>
<label class="flex items-center gap-3 self-end rounded-xl border p-3 text-sm"><input type="checkbox" name="require_jsa_active" value="1" @checked($values['require_jsa_active'] === '1')> <span class="font-semibold">Wajib JSA aktif untuk readiness drilling</span></label>
<label class="block text-sm font-semibold">Batas Sediment Maks (mm)<span class="help-text block">Kosongkan untuk mematikan gate sediment (record only)</span><input type="number" step=".01" min="0" name="sediment_max_mm" value="{{ $values['sediment_max_mm'] }}" placeholder="OFF" class="mt-1 w-full rounded-xl border p-3"></label>
<label class="flex items-center gap-3 self-end rounded-xl border p-3 text-sm"><input type="checkbox" name="slurry_policy_enabled" value="1" @checked($values['slurry_policy_enabled'] === '1')> <span class="font-semibold">Aktifkan kebijakan limit slurry</span></label>
<label class="block text-sm font-semibold">Slurry Density Min/Max<input type="text" name="slurry_density_min" value="{{ $values['slurry_density_min'] }}" placeholder="min — kosong = OFF" class="mt-1 w-full rounded-xl border p-3"><input type="text" name="slurry_density_max" value="{{ $values['slurry_density_max'] }}" placeholder="max — kosong = OFF" class="mt-1 w-full rounded-xl border p-3"></label>
<label class="block text-sm font-semibold">Slurry Viskositas Min/Max<input type="text" name="slurry_viscosity_min" value="{{ $values['slurry_viscosity_min'] }}" placeholder="min — kosong = OFF" class="mt-1 w-full rounded-xl border p-3"><input type="text" name="slurry_viscosity_max" value="{{ $values['slurry_viscosity_max'] }}" placeholder="max — kosong = OFF" class="mt-1 w-full rounded-xl border p-3"></label>
<label class="block text-sm font-semibold">Slurry pH Min/Max<input type="text" name="slurry_ph_min" value="{{ $values['slurry_ph_min'] }}" placeholder="min — kosong = OFF" class="mt-1 w-full rounded-xl border p-3"><input type="text" name="slurry_ph_max" value="{{ $values['slurry_ph_max'] }}" placeholder="max — kosong = OFF" class="mt-1 w-full rounded-xl border p-3"></label>
<label class="block text-sm font-semibold">Slurry Sand Content Maks (%)<input type="text" name="slurry_sand_content_max" value="{{ $values['slurry_sand_content_max'] }}" placeholder="kosong = OFF" class="mt-1 w-full rounded-xl border p-3"></label>
<label class="flex items-center gap-3 self-end rounded-xl border p-3 text-sm"><input type="checkbox" name="tremie_log_enabled" value="1" @checked($values['tremie_log_enabled'] === '1')> <span class="font-semibold">Aktifkan tremie log sebagai checklist readiness casting</span></label>
<label class="block text-sm font-semibold">Tremie Embedment Maks (m)<span class="help-text block">Kosongkan bila tidak ada batas atas</span><input type="number" step=".01" min="0" name="tremie_max_embedment_m" value="{{ $values['tremie_max_embedment_m'] }}" placeholder="OFF" class="mt-1 w-full rounded-xl border p-3"></label>
<label class="block text-sm font-semibold">Arsip Otomatis Setelah Proyek Close (hari)<span class="help-text block">Kosongkan = OFF — tidak ada perubahan status otomatis</span><input type="number" min="0" name="archive_after_project_closed_days" value="{{ $values['archive_after_project_closed_days'] }}" placeholder="OFF" class="mt-1 w-full rounded-xl border p-3"></label>
<label class="block text-sm font-semibold">Jeda Hapus Fisik Setelah Arsip (hari)<span class="help-text block">Kosongkan = penghapusan fisik dinonaktifkan total (default)</span><input type="number" min="0" name="delete_after_archive_days" value="{{ $values['delete_after_archive_days'] }}" placeholder="OFF" class="mt-1 w-full rounded-xl border p-3"></label>
</div>
<div class="mt-4">

...
<div class="grid gap-2 sm:grid-cols-4 lg:grid-cols-5"><input name="delivery_lead_days" type="number" min="0" placeholder="Lead time (hari)" class="rounded-xl border p-3"><input name="warranty_months" type="number" min="0" max="120" placeholder="Garansi (bulan)" class="rounded-xl border p-3"><input name="payment_term" placeholder="Termin bayar" class="rounded-xl border p-3"><input name="technical_score" type="number" step=".01" min="0" max="100" placeholder="Skor teknis" class="rounded-xl border p-3"><input name="commercial_score" type="number" step=".01" min="0" max="100" placeholder="Skor komersial" class="rounded-xl border p-3"></div>

...
| Engineering & Workshop | BOM, routing work center, WIP reconciliation, QC disposition, equipment hour meter/fuel (potong otomatis tangki BBM)/MWO (+tutup WO → registry), cage (konsumsi material ber-jurnal) + casing sewa (jurnal otomatis) + foto evidence | `manufacturing.*`, `equipment.*` |

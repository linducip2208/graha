...
| CRM/Tender/Contract | Tidak | Tidak | Ya | BPM belum tersedia | P1 | Fase 2 |
| Project/Bored Pile | Tidak | Tidak | Ya | dependency award | P1 | Fase 3 |
| Procurement/Inventory | Tidak | Tidak | Ya | ledger dan locking | P1 | Fase 4 |
| Manufacturing/Equipment | Tidak | Tidak | Ya | traceability | P2 | Fase 5 |
| Finance/Accounting | Tidak | Tidak | Ya | mapping akun | P1 | Fase 6 |
| QMS/HSE | Tidak | Tidak | Ya | configurable ISO | P1 | Fase 7 |
| Reporting | Ya | Ya | Tidak | dashboard fondasi | P2 | Fase 8 |
